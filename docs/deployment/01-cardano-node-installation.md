...
| `NODE_VERSION`         | `11.1.2`                                  | The current node version. Must be > the version defined here. Binaries are downloaded from [IntersectMBO cardano-node releases](https://github.com/intersectmbo/cardano-node/releases). Linux and macOS arm64 builds require node version 10.6.2 or later. |
